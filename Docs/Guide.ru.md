...
| Modules | Монетизация, игроки, игра, контент и интеграция: провайдер каждого модуля в каждой конфигурации. Покупки, лидерборды, флаги и языки описываются здесь. |
