...
| 22.09.2026 | Новый раздел «Главная» открывается первым: баннер со ссылкой на конфигурации и плитками площадок, последние сборки и панель активной цели. В панели настройки сборки и проекта для активной конфигурации, путь и имя сборки, кнопка «Собрать проект». История сборок хранится у каждого пользователя в `UserSettings/JTLSDKBuildHistory.asset`, последние 20 записей. |
