...
| 22.09.2026 | В меню тулкита одна группа MODULES с двумя подкатегориями: Configurable / «Настраиваемые» (покупки, сохранения, языки, лидерборды, флаги) и Out of the box / «Из коробки» (реклама, игровые события, пауза, время, звук, игрок, площадка, отзыв, ярлык игры). Отдельной группы Features больше нет. |
