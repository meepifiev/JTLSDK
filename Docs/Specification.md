...
| 22.09.2026 | В меню тулкита одна группа MODULES с подкатегориями: Monetization (реклама, покупки), Players (игрок, сохранения, лидерборды), Game (игровые события, пауза, время, звук), Content (языки, флаги), Integration (площадка, отзыв, ярлык игры). Отдельной группы Features больше нет. |
